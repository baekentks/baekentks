...
$(document).ready(function(){
	...
	if(!isMobile){
		...
		// Mobile
			...
			var two_slide_02 = visual_Slides(".sec_commu", ".slides", false, "slide");
			var rolling_slide_02 = rolling_slide(".sec_teaware", 5, 3, 1);
			var rolling_slide_03 = rolling_slide(".sec_dessert", 5, 3, 1);
			var slide_03 = visual_Slides(".sec_event", ".slides", false, "slide");
	...
	var rolling_slide_01 = rolling_slide(".sec_product", 5, 3, 1);
	var sec_about_ani_01 = about_ani(500);
